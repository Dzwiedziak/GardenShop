...
<script>
    ...
    onMount(async () => {
         ...
         photo = await fetchPhotoById(product.photo_id);
...
<main class="container">
 {#if ready}
  ...
  <div class="left-column">
    <img src="data:image/{photo.extension};base64,{photo.base64}" alt="product"/>
  </div>
  ...
  <div class="right-column">
    ...
    <div class="product-price">
      ...
      <div href="#" class="cart-btn">Dodaj do koszyka</div>
    </div>
  </div>
  {/if}
</main>
